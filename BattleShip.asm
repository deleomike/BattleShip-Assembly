...
Prompt_Random_Setup: .asciiz "Random Setup? Y/N"
...
Carrier_Data:
	...
	.word 	0,0	#array for letter coordinates, array for number coordinates
	#may need more data
BattleShip_Data:
...
Destroyer_Location_X: .word -1,-1,-1
...
la $a0, Carrier_Data
la $a1, Carrier_Location_X
la $a2, Carrier_Location_Y
jal Write_Array_Data	#Write location arrays
#\	=[] 
#- made by my dog vinny


la $a0, BattleShip_Data
la $a1, BattleShip_Location_X
la $a2, BattleShip_Location_Y
jal Write_Array_Data	#Write location arrays



la $a0, Submarine_Data
la $a1, Submarine_Location_X
la $a2, Submarine_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, Cruiser_Data
la $a1, Cruiser_Location_X
la $a2, Cruiser_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, Destroyer_Data
la $a1, Destroyer_Location_X
la $a2, Destroyer_Location_Y
jal Write_Array_Data	#Write location arrays

#initilaize AI (PANDA) Ship Data

la $a0, AI_Carrier_Data
la $a1, AI_Carrier_Location_X
la $a2, AI_Carrier_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, AI_BattleShip_Data
la $a1, AI_BattleShip_Location_X
la $a2, AI_BattleShip_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, AI_Submarine_Data
la $a1,	AI_Submarine_Location_X
la $a2, AI_Submarine_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, AI_Cruiser_Data
la $a1, AI_Cruiser_Location_X
la $a2, AI_Cruiser_Location_Y
jal Write_Array_Data	#Write location arrays


la $a0, AI_Destroyer_Data
la $a1, AI_Destroyer_Location_X
la $a2, AI_Destroyer_Location_Y
jal Write_Array_Data	#Write location arrays
...
la $a0, Carrier_Data
jal Is_Ship_Alive
beqz $v0, Salvo_Skip_Carrier

la $a0, Carrier_name	#loads carrier name
...
la $a0, BattleShip_name	#loads battleship name
jal Print_String	#prints carrier
jal User_Shoot_Once
#put function in here for above process

la $a0,Submarine_Data
jal Is_Ship_Alive

la $a0, Submarine_name	#loads submarine name
jal Print_String	#prints carrier
jal User_Shoot_Once
#TODO
...
la $a0, Cruiser_name	#loads cruiser name
jal Print_String	#prints carrier
jal User_Shoot_Once
#TODO
...
la $a0, Destroyer_name	#loads carrier name
jal Print_String	#prints carrier
jal User_Shoot_Once
#TODO Function
#MAKE SURE IT GETS ALL OF THE COORDINATES FIRST, THEN EVALUATES#!!!!!!
...
move $v0, $t3	#copy sum of dead ships to V0
lw $ra, 0($sp)
addiu $sp, $sp, 24
jr $ra
